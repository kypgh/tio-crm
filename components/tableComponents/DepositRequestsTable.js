...
const DepositRequestActions = ({ request }) => {
  ...
  const {
        ...
        .then((res) => res.data),
    {
      ...
      fieldFunctionality: {
        ...
        actions: {
          format: (v, doc) => <DepositRequestActions request={doc} />,
        },
        createdAt: {
...
export default DepositRequestsTables;
